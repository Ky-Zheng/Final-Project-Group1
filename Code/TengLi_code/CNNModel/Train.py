...
for it in range(niter):
    ...
    ave_acc.append(solver.test_nets[0].blobs['accuracy'].data)
...
print 'average accuracy is ', np.mean(ave_acc)
...
def vis_square_f(data):
    """Take an array of shape (n, height, width) or (n, height, width, 3)
       and visualize each (height, width) thing in a grid of sizes approx. sqrt(n) by sqrt(n)"""
